...
- **AI Coach:** Personalized post-game analysis using LLMs to explain tactical errors based on PGN data.
- **Spectator Support:** Pub/Sub architecture via Redis to support thousands of concurrent viewers.
...
- **Chess Logic:** Chess.js (Rules engine) + React-chessboard.
...
│   │   ├── engine/          # Chess logic and Stockfish integration
│   │   ├── game/            # WebSocket orchestrator and game rooms
│   │   ├── models/          # Domain entities (User, Game, Move)
│   │   ├── repository/      # Database implementations (Postgres/Redis)
│   │   └── service/         # Business logic (Rankings, Game Processing)
